        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    StudentRecordId = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Documents_StudentRecords_StudentRecordId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reports_StudentRecords_StudentRecordId",
                        column: x => x.StudentRecordId,
                        principalTable: "StudentRecords",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Documents_StudentRecordId",
                table: "Documents",
                column: "StudentRecordId");

            migrationBuilder.CreateIndex(
                name: "IX_Reports_StudentRecordId",
                table: "Reports",
                column: "StudentRecordId");
        }
