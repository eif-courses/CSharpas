        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExternalReviewers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExternalReviewerReports", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExternalReviewerReports_Documents_DocumentId",
                        column: x => x.DocumentId,
                        principalTable: "Documents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExternalReviewerReports_ExternalReviewers_ReviewerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExternalReviewerReports_DocumentId",
                table: "ExternalReviewerReports",
                column: "DocumentId");

            migrationBuilder.CreateIndex(
                name: "IX_ExternalReviewerReports_ReviewerId",
                table: "ExternalReviewerReports",
                column: "ReviewerId");
